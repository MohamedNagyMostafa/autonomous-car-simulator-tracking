...
private:
    ...
    ros::Subscriber cameraSensorSubscriber;
    ...
    void cameraSubscriberCallback(const sensor_msgs::Image& msg);
...
public:
    ...
    */
    ...
    ImageStream(ros::NodeHandle& nodeHandle,  DataFrame* dataFrame);  // Reading from sensor.
    ~ImageStream();
