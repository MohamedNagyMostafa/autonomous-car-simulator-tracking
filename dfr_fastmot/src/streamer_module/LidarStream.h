...
private:
    ...
    ros::Subscriber liderSubscriber;
...
public:
    ...
    LidarStream(ros::NodeHandle& nodeHandle, DataFrame *dataFrame); // Read from LiDAR sensor

    void lidarCallback(const sensor_msgs::PointCloud::ConstPtr& cloudMsg);
