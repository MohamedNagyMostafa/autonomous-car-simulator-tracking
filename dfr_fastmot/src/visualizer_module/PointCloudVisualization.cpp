                                                     ...
                                                     PointCloudVisualization::RGB color)
{
    ...
    for(const auto object : objects)
    {
        ...
        {
            std::cout<<"3D bounding box is found"<<std::endl;
            long unique = random();
...
//
            viewer->addCube(object->_3dBoxLiDAR->stateEstimation3D_min(0), object->_3dBoxLiDAR->stateEstimation3D_max(0),
                            object->_3dBoxLiDAR->stateEstimation3D_min(1), object->_3dBoxLiDAR->stateEstimation3D_max(1),
                            object->_3dBoxLiDAR->stateEstimation3D_min(2), object->_3dBoxLiDAR->stateEstimation3D_max(2),
                            0, 255, 0, cubeIdEst);
            viewer->addCube(object->_3dBoxLiDAR->x_min, object->_3dBoxLiDAR->x_max,
                            object->_3dBoxLiDAR->y_min, object->_3dBoxLiDAR->y_max,
...
//                            color.red, color.green, color.blue, cubeFillId);
            ...
            viewer->addText3D(std::to_string(object->trackId),
                    pcl::PointXYZ(object->_3dBoxLiDAR->x_max,object->_3dBoxLiDAR->y_max,object->_3dBoxLiDAR->z_max));
