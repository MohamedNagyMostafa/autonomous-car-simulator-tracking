...
public:
    ...
    {
        ifstream file2D;
        file2D.open("/home/mohamed-nagy/Desktop/catkin_ws_tracker/src/dfr_fastmot/src/advanced_detection/det_2d/" + streamfile+".txt");
    ...
    {
        ifstream file3D;
        //TODO: change to ur directory
        file3D.open("/home/mohamed-nagy/Desktop/Thesis Project/3D-MOT-FeatureBased/src/advanced_detection/det_3d/" + streamfile+".txt");
    ...
    {
        ifstream file2D;
        file2D.open("/home/mohamed-nagy/Desktop/Thesis Project/3D-MOT-FeatureBased/src/advanced_detection/pointgnn/" + streamfile+".txt");
