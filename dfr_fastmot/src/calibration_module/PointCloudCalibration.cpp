...
void PointCloudCalibration::runSensorProjection(pcl::PointCloud<pcl::PointXYZ>::Ptr pointClouds, std::vector<Object*>& objects, float shrinkFactor) {
...
//        std::cout<<"transfored point " << pt.x << " " << pt.y<<std::endl;
        int objectIndex = -1;
